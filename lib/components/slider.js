...
class Slider extends React.Component {
  ...
  scrollToSlide(slide, override) {
    ...
    scrollTo(GET_BODY(), SCROLL_DIR, this.state.hSlides[slide], 600, () => {
      this.setState({'activeSlide': slide});
      this.setState({'scrollPending': false});
    });
  }
...
function handleScroll(e, comp, axis) {
  ...
  console.log(e);
  console.log('X', e.wheelDeltaX);
  console.log('Y', e.wheelDeltaY);
  console.log('delta', e.wheelDelta, comp.state.downThreshold * 2)

  // console.log(e.wheelDelta, comp.state.downThreshold)
