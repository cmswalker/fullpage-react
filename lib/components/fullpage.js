...
const BROWSER = renderUtils.browser();
const ELEMENT_BROWSERS = renderUtils.elementBrowsers;

const BODY = !!~ELEMENT_BROWSERS.indexOf(BROWSER) ? document.documentElement : document.body;
